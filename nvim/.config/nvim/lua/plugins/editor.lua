return {
	...
	--      { "<leader>E", ":NnnExplorer<CR>", { noremap = true, desc = "nnn Explorer" }}
	--
	-- 	},
	-- 	deactivate = function()
	...
	-- with the active keybindings of the command you started typing.
	{
		...
		opts = {
			...
			spec = {
				{
					mode = { "n", "v" },
					-- Only define custom groups or override default styling
					-- LazyVim already provides most of these groups, so we only add custom ones or override styling
					{ "<leader>u", group = "ui", icon = { icon = "󰙵 ", color = "cyan" } },
					{ "<leader>x", group = "diagnostics/quickfix", icon = { icon = "󱖫 ", color = "green" } },
					-- Add our custom tmux window switching group
					{ "<leader>w", group = "tmux windows", icon = { icon = "󰓩 ", color = "blue" } },
					{ "<leader>we", desc = "Switch to neovim window" },
					{ "<leader>wg", desc = "Switch to lazy_git window" },
					{ "<leader>wa", desc = "Switch to ai_cli window" },
					{ "<leader>wc", desc = "Switch to rails_console window" },
					{ "<leader>ws", desc = "Switch to server window" },
					-- Also add Ctrl+w tmux window switching descriptions
					{ "<C-w>e", desc = "Switch to neovim window" },
					{ "<C-w>g", desc = "Switch to lazy_git window" },
					{ "<C-w>a", desc = "Switch to ai_cli window" },
					{ "<C-w>c", desc = "Switch to rails_console window" },
					{ "<C-w>s", desc = "Switch to server window" },
					-- GitHub keybindings
